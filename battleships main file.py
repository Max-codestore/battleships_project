...
def battle():
    global p1first_smoke_shot,p2first_smoke_shot,p1smoke_charges,p2smoke_charges,reset,gameend,p1hp,p2hp,firstime,p1smoke,p2smoke,p1smoke_time,p2smoke_time,p1armour,p1gunsc,p1gunsn,p2armour,p2gunsc,p2gunsn,shots1,shots2,gameend,your_turn,their_turn,p1
    your_turn = 1
    their_turn = 1
    magdet = [23]
